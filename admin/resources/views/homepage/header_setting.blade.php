            ...
            <div class="row">
                ...
                <div class="col-md-6 mb-3">
                    ...
                    @if(!empty($setting->logo))
                        <img src="{{ config('uploads.url') . '/' . $setting->logo }}" class="mt-2" height="60">
                    @endif
                </div>
                ...
                <div class="col-md-6 mb-3">
                    ...
                    @if(!empty($setting->favicon))
                        <img src="{{ config('uploads.url') . '/' . $setting->favicon }}" class="mt-2" height="40">
                    @endif
                </div>
                ...
                <div class="col-md-6 mb-3">
                    ...
                    <input type="text" name="offer_title" value="{{ $setting->offer_title ?? '' }}" class="form-control">
                </div>

                <div class="col-md-6 mb-3">
                    <label class="form-label">Offer Banner Image</label>
                    <input type="file" name="offer_banner" class="form-control">
                    @if(!empty($setting->offer_banner))
                        <img src="{{ config('uploads.url') . '/' . $setting->offer_banner }}" class="mt-2" height="40">
                    @endif
                </div>

                <div class="col-md-12 mb-3">
                    <label class="form-label">Animated Title 1</label>
                    <input type="text" name="animated_title_1" value="{{ $setting->animated_title_1 ?? '' }}" class="form-control">
                </div>

                <div class="col-md-12 mb-3">
                    <label class="form-label">Animated Title 2</label>
                    <input type="text" name="animated_title_2" value="{{ $setting->animated_title_2 ?? '' }}" class="form-control">
                </div>
